...
class Dashboard(QWidget):
    ...
    def plot_data(self):
        ...
        # **Check if `grouped` contains data before highlighting bars**
        if len(grouped) > 0:
            ...
            try:
                ...
                pass  # Handle the case where indices are out of range
        ...
        # **Ensure `patches` list is populated before adding interactive tooltips**
        ...
        # **Check if `full_df` contains data before plotting points in the line chart**
        ...
        # **Ensure `patches` list is populated before highlighting bars**
